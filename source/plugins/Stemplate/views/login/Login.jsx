    ...
    get(ForgotPassword) {
        ...
        return {
            ...
            logIn() {
                ...
                //
                // core.plugins.Stemplate.run('logIn',{email: email, password: password})
                // .then( (result) => {
                //
                //     core.plugins.Stemplate.set(['currentUser'], result.user);
                    setTimeout(()=>{
                      core.plugins.Stemplate.set(['isLoggedIn'], true);
                ...
                //
                //     this.clearFields();
                //     core.plugins.Stemplate.set(['isLoggedIn'], false);
                //     this.setState({isWaiting: false});
                //
                // } )
            },
